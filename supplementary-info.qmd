---
title: "Evaluating the Ecological Importance of a Conservation Status on Forest Structure and Composition Across Urban Woodlands"
format:
  pdf:
    fig-width: 12
    fig-height: 14
...
trees_adult %>% 
  ...
  summarize(Native = first(Native_ETF),
